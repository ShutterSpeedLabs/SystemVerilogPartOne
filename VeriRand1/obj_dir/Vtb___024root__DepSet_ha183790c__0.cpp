...
void Vtb___024root___timing_resume(Vtb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        vlSelf->__VtrigSched_h756fa6fb__0.resume("@([changed] tb.drv.next.isTriggered())");
    }
...
void Vtb___024root___timing_commit(Vtb___024root* vlSelf) {
    ...
    // Body
    if ((! (1ULL & vlSelf->__VactTriggered.word(0U)))) {
        vlSelf->__VtrigSched_h756fa6fb__0.commit("@([changed] tb.drv.next.isTriggered())");
    }
}
...
#endif
            VL_FATAL_MT("VeriRand1/tb.sv", 6, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("VeriRand1/tb.sv", 6, "", "Active region did not converge.");
            }
